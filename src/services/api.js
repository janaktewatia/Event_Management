...
export const fetchUserFields = () =>
  req("/user-fields").then(normAll);

export const createUserField = (data) =>
  req("/user-fields", { method: "POST", body: JSON.stringify(data) }).then(norm);

export const patchUserField = (id, data) =>
  req(`/user-fields/${id}`, { method: "PUT", body: JSON.stringify(data) }).then(norm);
...
export const fetchEventTypes = () =>
  req("/event-types").then(normAll);

export const createEventType = (data) =>
  req("/event-types", { method: "POST", body: JSON.stringify(data) }).then(norm);

export const patchEventType = (id, data) =>
  req(`/event-types/${id}`, { method: "PUT", body: JSON.stringify(data) }).then(norm);
...
export const createAttendee = (eventId, data) =>
  req("/attendees", { method: "POST", body: JSON.stringify({ eventId, ...data }) }).then(norm);
...
export const patchAttendee = (id, data) =>
  req(`/attendees/${id}`, { method: "PUT", body: JSON.stringify(data) }).then(norm);

export const removeAttendee = (id) =>
  req(`/attendees/${id}`, { method: "DELETE" });

// ── Pass Templates ───────────────────────────────────────────────────────────
export const fetchPassTemplates = () =>
  req("/pass-templates").then(normAll);

export const createPassTemplate = (data) =>
  req("/pass-templates", { method: "POST", body: JSON.stringify(data) }).then(norm);

export const updatePassTemplate = (id, data) =>
  req(`/pass-templates/${id}`, { method: "PUT", body: JSON.stringify(data) }).then(norm);
...
export const loginUser = (userId, password) =>
  req("/auth/login", { method: "POST", body: JSON.stringify({ userId, password }) });

export const verify2FA = (userId, token, isSetup = false) =>
  req("/auth/2fa/verify", { method: "POST", body: JSON.stringify({ userId, token, isSetup }) });

// ── User Types ────────────────────────────────────────────────────────────────
export const fetchUserTypes = () =>
  req("/user-types").then(normAll);
...
export const patchUserType = (id, data) =>
  req(`/user-types/${id}`, { method: "PUT", body: JSON.stringify(data) }).then(norm);
...
export const patchAppUser = (id, data) =>
  req(`/app-users/${id}`, { method: "PUT", body: JSON.stringify(data) }).then(norm);
