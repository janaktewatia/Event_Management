...
export const Route = createFileRoute("/modules/integrations-whatsapp")({
  head: () => ({
    meta: [
      { title: "WhatsApp Integration — OrbitOps" },
      { name: "description", content: "Connect Meta Cloud API or BSP vendor for WhatsApp." },
    ],
  }),
